...
curl -OL https://raw.githubusercontent.com/celik23/bash/main/oraichain/docker-compose.prod.yml && curl -OL https://raw.githubusercontent.com/celik23/bash/main/oraichain/orai.env
